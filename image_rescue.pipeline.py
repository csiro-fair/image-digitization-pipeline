...
class ImageRescuePipeline(BasePipeline):
    ...
    def copy_and_rotate_image(src_path, dest_path, rotation_flag, gps_info=None, time_info=None):
        ...
        with Image.open(src_path) as img:
            ...
            if gps_info:
                ...
                gps_ifd = {
                    piexif.GPSIFD.GPSLatitudeRef: to_deg(latitude, ["N", "S"])[-1],
                    piexif.GPSIFD.GPSLatitude: to_deg(latitude, ["N", "S"])[:-1],
                    piexif.GPSIFD.GPSLongitudeRef: to_deg(longitude, ["E", "W"])[-1],
                    piexif.GPSIFD.GPSLongitude: to_deg(longitude, ["E", "W"])[:-1]
                }
    ...
    def interpolate_points(start_lat, start_long, end_lat, end_long, start_time, end_time, n_points):
        ...
        # TODO: Correct to UTC time based on UTC Offset
